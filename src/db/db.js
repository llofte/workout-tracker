...
export const MOVEMENTS_BASELINE = [
  ...
  { name: 'Power Snatch', aliases: ['P.SN', 'PS'], category: 'weightlifting', prs: [{ date: '2026-06-12', reps: 2, weight: 57, weightUnit: 'lbs', sessionId: null }] },
  ...
  { name: 'Jerk', aliases: ['J'], category: 'weightlifting', prs: [] },
  { name: 'SA DB Snatch', aliases: [], category: 'weightlifting', prs: [] },
  { name: 'KB Swing', aliases: [], category: 'other', prs: [] },
  { name: 'Bulgarian Split Squat', aliases: ['BSS'], category: 'strength', prs: [] },
  { name: 'DB Step-Up', aliases: [], category: 'strength', prs: [] },
  { name: 'SA OH Lunge', aliases: [], category: 'strength', prs: [] },
  { name: 'V-Up', aliases: [], category: 'gymnastics', prs: [] },
  { name: 'Lateral Sprawl DB Jump', aliases: [], category: 'other', prs: [] },
  { name: 'DB Plank Reach Through', aliases: [], category: 'gymnastics', prs: [] },
  { name: 'Weighted Sit-Up', aliases: [], category: 'gymnastics', prs: [] },
  { name: 'Burpee', aliases: [], category: 'other', prs: [] },
