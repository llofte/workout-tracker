    ...
    <div style={{ ...S.root, paddingBottom: kbOpen ? 24 : S.root.paddingBottom }}>
      <div style={S.header}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ backgroundColor: 'transparent', color: '#f560ff', fontSize: 10, fontWeight: 700, borderRadius: 5, padding: '2px 5px', letterSpacing: 0.3, border: '1px solid #f560ff' }}>v153</span>
        </div>
